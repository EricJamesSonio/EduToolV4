...
RUBRIC FLOW
Admin sets default rubric
Educator creates personal rubrics
Assign rubric to class
Once students exist → LOCKED

Frontend must:

Enforce weight = 100%
Handle locked state (disable editing)
Support category-based grading UI