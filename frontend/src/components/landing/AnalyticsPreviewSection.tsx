// components/landing/AnalyticsPreviewSection.tsx  ← full updated file
"use client";
...
const stats = [
  { icon: Users,     label: "Active Schools",        value: "1,240+", color: "bg-blue-500",    barWidth: "88%" },
  { icon: PieChart,  label: "Registered Programs",   value: "320+",   color: "bg-purple-500",  barWidth: "74%" },
  { icon: TrendingUp,label: "User Satisfaction",     value: "96%",    color: "bg-emerald-500", barWidth: "94%" },
  { icon: BarChart3, label: "Total Admins",           value: "8,500+", color: "bg-orange-500",  barWidth: "68%" },
  { icon: Calendar,  label: "Monthly Active Usage",   value: "450K+",  color: "bg-cyan-500",    barWidth: "82%" },
];
...
export function AnalyticsPreviewSection() {
  ...
  return (
    <section
      ...
      className={`page-container py-6 md:py-10 space-y-14 ${isInView ? "animate-section-in" : ""}`}
      ref={ref}
    >
      {/* Header */}
