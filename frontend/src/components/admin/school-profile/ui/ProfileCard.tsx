...
/** Small label used inside course/strand level-pill buttons: name + a quick sec/subj count. */
export function LevelPillLabel({ level }: { level: DraftLevel }) {
  return (
...
/** Plain, always-open card shell used throughout this page. */
...
/** Collapsible variant of Card — used for each department in View mode. */
