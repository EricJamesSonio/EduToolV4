...
export const SHS_STRANDS = [
  ...
  "HE", "IA", "Agri-Fishery", "Sports", "Arts and Design",
]

// ─── Minor subject definitions ────────────────────────────────────────────────
// These are seeded once and shared (via SubjectSharing) across all courses/strands
...
// ─── SHS strand subjects (first 10 = minors, rest = majors) ──────────────────
...
// ─── College course subjects (first 10 = GE minors, rest = majors) ────────────
