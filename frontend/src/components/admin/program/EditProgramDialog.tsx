  ...
  const handleClose = () => {
    ...
    updateMutation.mutate(
        ...
        onError: (err) => {
            ...
            toast.error(axiosErr?.response?.data?.message ?? "Failed to update program.");
        },
        }
    );
    };
      ...
      <DialogContent className="sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-1">
          ...
          <div className="space-y-1.5">
            ...
            >
              <SelectTrigger>
                <SelectValue>{PROGRAM_TYPE_LABELS[selectedType] ?? "Select type"}</SelectValue>
              </SelectTrigger>
              <SelectContent>
