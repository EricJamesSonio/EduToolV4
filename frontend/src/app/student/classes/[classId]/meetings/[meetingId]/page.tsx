...
export default function StudentClassMeetingDetailPage(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        breadcrumbs={[
          { label: "Meetings", href: `/student/classes/${classId}/meetings` },
            ...
            <div className="pt-1">
              {meeting.isInvited ? (
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/student/classes/${classId}/meetings/${meetingId}/room`
                    )
                  }
                >
                  {isLive ? (
