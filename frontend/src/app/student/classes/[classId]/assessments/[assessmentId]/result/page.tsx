                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isManual ? "border-l-4 border-l-blue-400 bg-blue-50/20" : isCorrect ? "border-emerald-200" : isWrong ? "border-red-200" : "border-border/60"
                    )}
                  >
                      ...
                      <div className="space-y-1 flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[11px] font-medium uppercase tracking-wider text-muted-foreground">
                            {isManual ? 'Instructions' : q.type?.replace(/_/g, " ")}
                          </span>
                          {!isManual && isCorrect && <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" />}
                          {!isManual && isWrong && <XCircle className="h-3.5 w-3.5 text-red-500" />}
                        </div>
                        <p className={cn("text-sm text-foreground leading-relaxed pt-1", isManual && "font-medium")}>
                          {q.questionText}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <p className={cn(
                        ...
                        isManual ? "bg-white border-blue-200 text-foreground" : isCorrect ? "bg-emerald-50 border-emerald-200 text-emerald-800" : isWrong ? "bg-red-50 border-red-200 text-red-800" : "bg-muted border-border"
                      )}>
                    ...
                    {!isManual && isWrong && q.correctAnswer && (
                      <div className="text-sm space-y-1">
