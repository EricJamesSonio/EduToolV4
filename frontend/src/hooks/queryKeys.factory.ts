// ===== File: frontend\src\hooks\queryKeys.factory.ts =====

type QueryFilters = unknown;
  ...
  admin: {
    ...
    classes: {
      ...
      eligibleStudents: (classId: string) =>
        [...adminKeys.all, 'classes', 'detail', classId, 'eligible-students'] as const,
    },
    ...
    educators: {
      ...
      assignments: (educatorId: string) =>
        [...adminKeys.all, 'educators', 'detail', educatorId, 'assignments'] as const,
    },
    ...
    enrollmentPortal: {
      ...
      dashboard: (periodId?: string) =>
        [...adminKeys.all, 'enrollmentPortal', 'dashboard', periodId ?? 'all'] as const,

      periods: {
        all: [...adminKeys.all, 'enrollmentPortal', 'periods'] as const,
        list: (filters?: QueryFilters) =>
          [...adminKeys.all, 'enrollmentPortal', 'periods', 'list', filters] as const,
        detail: (id: string) =>
          [...adminKeys.all, 'enrollmentPortal', 'periods', 'detail', id] as const,
      },

      applications: {
        all: [...adminKeys.all, 'enrollmentPortal', 'applications'] as const,
        list: (filters?: QueryFilters) =>
          [...adminKeys.all, 'enrollmentPortal', 'applications', 'list', filters] as const,
        detail: (id: string) =>
          [...adminKeys.all, 'enrollmentPortal', 'applications', 'detail', id] as const,
      },
    },
    ...
    semesterTemplateAssignments: {
      ...
      list: (schoolYearId: string) =>
        [...adminKeys.all, 'semesterTemplateAssignments', 'list', schoolYearId] as const,
    },
    ...
    students: {
      ...
      enrollments: (studentId: string) =>
        [...adminKeys.all, 'students', 'detail', studentId, 'enrollments'] as const,
    },
...
detail: (meetingId: string) =>
  [...studentKeys.all, 'meetings', 'detail', meetingId] as const,
    ...
    transcript: {
      ...
      detail: () =>
        [...studentKeys.all, 'transcript', 'detail'] as const,
    },
  },
