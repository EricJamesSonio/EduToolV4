...
@Module({
  imports: [OrganizationModule, PlatformModule, AuthModule, GuideModule, PlatformRegistrationModule],
  exports: [OrganizationModule, PlatformModule, AuthModule, GuideModule, PlatformRegistrationModule],
})
