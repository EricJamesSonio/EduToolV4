...
// paste all your constants here (PROGRAMS, COLLEGE_COURSES, SHS_STRAND_DEFS, etc.)
// or import them from a shared seed-data.ts file
  ...
  private async seedPrograms(
    ...
    for (const p of PROGRAMS) {
      ...
      const rec = await this.db.program.upsert({
        ...
        update: {},import { Injectable } from '@nestjs/common'
import { DatabaseService } from '@/core/database/database.provider'
import { v4 as uuid } from 'uuid'
