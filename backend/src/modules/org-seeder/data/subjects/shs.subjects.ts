...
const SHS_MAJOR: Record<string, ShsSubjRaw[]> = {
  ABM: [
    ...
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['Fundamentals of Accounting', 'Principles of Management'],
    },
    {
      name: 'Business Finance',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Business Math', 'Fundamentals of Accounting'],
    },
    { name: 'Business Ethics', grade: 12, term: '2nd Semester', prereqs: [] },
    {
      ...
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Fundamentals of Economics'],
    },
    {
      name: 'Strategic Business Planning',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Entrepreneurship', 'Organization and Management'],
    },
  ],
  STEM: [
    ...
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['General Physics'],
    },
    {
      name: 'Organic Chemistry',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['General Chemistry'],
    },
    {
      name: 'Research in Science',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Engineering and Technology Applications',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      ...
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Calculus and Analytical Geometry'],
    },
  ],
  HUMSS: [
    {
    ...
    {
      name: 'Understanding Culture and Society',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    {
      ...
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Reading and Writing Skills'],
    },
    {
      name: 'Philippine Politics and Governance',
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Understanding Culture and Society'],
    },
    {
      name: 'Psychology',
      grade: 12,
    ...
    {
      name: 'Social Research and Statistics',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Contemporary World'],
    },
    {
      name: 'World History and Globalization',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Readings in Philippine History'],
    },
    {
      name: 'Philosophy of Human Person',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Introduction to Philosophy'],
    },
    {
      name: 'Economics for Social Sciences',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Applied Social Sciences / Ethics in Society',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Understanding the Self'],
    },
  ...
  GAS: [
    ...
    {
      name: 'Fundamentals of Business and Management',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Basic Principles of Science and Technology',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    ...
    {
      name: 'Research Methods / Applied Research',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Contemporary World'],
    },
    {
      ...
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Fundamentals of Business and Management'],
    },
    {
      name: 'Social Issues and Ethics',
      grade: 12,
      term: '2nd Semester',
      prereqs: ['Understanding the Self'],
    },
  ...
  ICT: [
    ...
    {
      name: 'Web Development 1 (HTML, CSS)',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    ...
    {
      name: 'Web Development 2 (JavaScript)',
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Web Development 1 (HTML, CSS)'],
    },
    {
    ...
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['Computer Programming 2', 'Database Management Systems'],
    },
    {
  ...
  HE: [
    ...
    },
    {
      ...
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Cookery / Culinary Basics'],
    },
    { name: 'Housekeeping', grade: 11, term: '2nd Semester', prereqs: [] },
    {
      name: 'Caregiving (Basic)',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Dressmaking / Tailoring',
      grade: 12,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Advanced Cookery / International Cuisine',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Cookery / Culinary Basics'],
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['Food and Beverage Services'],
    },
    {
      name: 'Entrepreneurship in Home Economics',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Work Immersion (OJT)',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Capstone Project / Practical Assessment',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
  ...
  IA: [
    {
      name: 'Introduction to Industrial Arts',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Basic Electrical Installation and Maintenance',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    ...
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['Basic Electrical Installation and Maintenance'],
    },
    {
      name: 'Shielded Metal Arc Welding (SMAW) NC II',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Shielded Metal Arc Welding (SMAW) NC I'],
    },
    {
      name: 'Advanced Carpentry / Construction Technology',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Carpentry Fundamentals'],
    },
    {
  ...
  'Agri-Fishery': [
    {
      name: 'Introduction to Agri-Fishery Arts',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Crop Production (Basic)',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Animal Production (Basic)',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Aquaculture (Basic)',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      ...
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Crop Production (Basic)'],
    },
    {
      name: 'Agricultural Machinery and Tools',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Crop Production NC II',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Crop Production (Basic)'],
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['Animal Production (Basic)'],
    },
    {
      name: 'Aquaculture NC II',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Aquaculture (Basic)'],
    },
  ...
  Sports: [
    ...
    {
      name: 'Physical Fitness and Conditioning',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    ...
    {
      name: 'Sports Officiating and Rules',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    ...
    {
      name: 'Safety and First Aid in Sports',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Advanced Coaching and Training Techniques',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Fundamentals of Coaching'],
    },
    {
    ...
    {
      name: 'Anatomy and Physiology for Athletes',
      grade: 12,
      term: '1st Semester',
      prereqs: ['Introduction to Sports Science'],
    },
    {
      name: 'Sports Analytics and Performance Analysis',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
  ...
  'Arts and Design': [
    {
      name: 'Introduction to Arts and Design',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    ...
    {
      name: 'Creative Industries I (Applied Arts)',
      grade: 11,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Creative Industries II (Media Arts)',
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Creative Industries I (Applied Arts)'],
    },
    {
      name: 'Fundamentals of Performing Arts',
      grade: 11,
      term: '2nd Semester',
      prereqs: [],
    },
    {
      name: 'Visual Arts Production',
      grade: 11,
      term: '2nd Semester',
      prereqs: ['Elements and Principles of Design'],
    },
    {
      name: 'Specialization in Arts',
      grade: 12,
      term: '1st Semester',
      prereqs: [],
    },
    {
      ...
      grade: 12,
      term: '1st Semester',
      prereqs: ['Visual Arts Production'],
    },
    {
      name: 'Arts Production and Management',
      grade: 12,
      term: '1st Semester',
      prereqs: [],
    },
    {
      name: 'Contemporary Arts Practices',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
    ...
    {
      name: 'Capstone Project / Culminating Exhibit',
      grade: 12,
      term: '2nd Semester',
      prereqs: [],
    },
